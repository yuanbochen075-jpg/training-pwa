...
(function () {
  ...
  const COACH_OVERRIDES = {
    ...
    // 2026-08-30：补测 测试① 形态+弹跳基线（在家，室内可完成）
    '2026-08-30': {
      type: 'test', title: '测试①（补）形态+弹跳基线', venue: '家', duration: '45min',
      warmup: '动态热身10min + 慢跑5min',
      main: [
        { name: '体重/体脂', sets: 1, reps: '晨起空腹称重记录' },
        { name: '助跑摸高', sets: 3, reps: '取最好成绩', note: '墙标尺或手机App' },
        { name: '原地纵跳CMJ', sets: 3, reps: '取最好成绩' },
        { name: '立定跳远', sets: 3, reps: '取最好成绩' }
      ],
      note: '补测弹跳基线（已顺延3次）。在家室内可完成：摸高墙标尺/手机App、立定跳用卷尺+地板、CMJ用App。若旅途疲劳可改到9/2（周三恢复日）。',
      foods: [
