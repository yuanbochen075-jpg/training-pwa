...
(function () {
  ...
  const COACH_OVERRIDES = {
    ...
    // 2026-08-28：补测 测试② 短跑计时（原8/25→8/26顺延；若8/26已测速，本日按计划轻力量）
    '2026-08-28': {
      type: 'test', title: '测试②（补）短跑计时', venue: '田径场', duration: '50min',
      warmup: '动态热身15min + 2×30m加速',
      main: [
      ...
      note: '补测基线。8/27 深蹲金字塔后仅隔24h：热身务必充分，若腿发沉可顺延到8/30（周日）再测，宁缓勿伤。若8/26已测速，本日改做计划内「轻力量」即可。'
    },
    ...
    '2026-08-29': {
      ...
      note: '补测弹跳基线（距8/27力量已隔2天，腿基本恢复）。1000m 对短跑价值最低本周放弃；如想测，之后找个轻松日补。',
      foods: [
