...
(function () {
  ...
  const COACH_OVERRIDES = {
    ...
    '2026-08-27': {
      ...
      note: '补测基线（原8/24顺延，因8/23自我训练下肢量偏大+睡眠一般）。测完若轻松加10min Zone2慢跑。',
      foods: [
    ...
    // 2026-08-29：补测 测试③ 1000m（原8/26顺延）
    '2026-08-29': {
      type: 'test', title: '测试③（补）1000m', venue: '田径场', duration: '40min',
      warmup: '动态热身 + 慢跑10min',
      main: [
        { name: '1000m', sets: 1, reps: '全力计时', note: '记录成绩（不追2:50）' }
      ],
      note: '补测基线（原8/26顺延，因8/26补测短跑计时）。400m留到第2周单独测。',
      foods: [
        { when: '测试前1.5h', items: '香蕉1根 + 燕麦粥（少量）' },
        { when: '测试后30min', items: '西瓜/橙汁 + 牛奶/鸡蛋' },
        { when: '晚餐', items: '蓝莓/番茄 + 鱼/鸡胸 + 米饭' }
